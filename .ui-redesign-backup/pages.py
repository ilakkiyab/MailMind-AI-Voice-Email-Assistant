...
FEATURES = (
    ...
    ("▣", "Read Inbox", "Listen to and review incoming messages from one focused workspace.", "Inbox"),
    ("✦", "AI Email Summary", "Turn long conversations into clear, actionable highlights.", "AI Assistant"),
...
def render_dashboard() -> None:
    _page_header("Your intelligent workspace", "AI Voice-Powered Email Assistant", "Write, understand, and organize email with less effort.")
    st.markdown(
        """
        <div class="hero">
...
def render_compose() -> None:
    ...
    st.markdown(
        '<div class="voice-panel"><strong>🎙 Record your email instruction</strong><p>Record a voice note, then transcribe it into editable text.</p></div>',
        unsafe_allow_html=True,
    )
    ...
    with st.form("compose_form"):
        ...
        ai_column, _, clear_column, send_column = st.columns([1.6, 2, 1, 1.25])
        with ai_column:
...
def render_ai_assistant() -> None:
    _placeholder_page("AI Assistant", "✦", "Summaries and writing assistance will live in this focused workspace.")
