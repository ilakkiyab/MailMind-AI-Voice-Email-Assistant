    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div class="status-card">
                <span class="status-dot"></span><strong>Phase 3</strong>
                <p>Speech-to-text, AI drafting and confirmed Gmail sending · Google OAuth setup required</p>
            </div>
            """,
            unsafe_allow_html=True,
        )
...
def run_app() -> None:
    ...
    st.set_page_config(
        page_title="AI Voice-Powered Email Assistant", page_icon="✉️",
