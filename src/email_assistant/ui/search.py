...
def render_search() -> None:
    page_header("Find a message", "Voice Email Search", "Speak or type a query to find the email you need.")
    ...
    for email in results:
        with st.container(border=True, key=f"search_card_{email.id}"):
